...
class LevelFilter extends React.Component {
    ...
    render() {
        return (
            <>
                <li> 
                    <input type="radio" name="level" className="form-check-input" value="All Level" 
                        onChange={(e) => this.levelChange(e.target.value)}/>
                    <label className="form-check-label">All Levels</label>
                </li>
                <li> 
                    <input type="radio" name="level" className="form-check-input" value="Beginner"
                        onChange={(e) => this.levelChange(e.target.value)}/>
                    <label className="form-check-label">Beginners</label>
                </li>
                <li> 
                    <input type="radio" name="level" className="form-check-input" value="Intermediate"
                        onChange={(e) => this.levelChange(e.target.value)}/>
